...
<body>
    ...
    <div class="container">
        ...
        <div class="subtitle">
            ...
            @auth
                <a href="{{route('parametre')}}" style="color: #ff9d1b;">Retour </a>
            @endauth
        </div>
        ...
        <section id="generales" class="faq-section">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer"><p>Rendez-vous sur la page d'inscription, remplissez le formulaire avec votre nom, email et mot de passe. Vous recevrez un email de confirmation. Cliquez sur le lien pour activer votre compte.</p></div>
            </div>
            <div class="faq-item">
                <div class="faq-question"><span>2. Comment se connecter à mon espace ?</span> <i class="fas fa-chevron-down"></i></div>
                <div class="faq-answer"><p>Utilisez votre adresse email et votre mot de passe sur la page de connexion. Vous pouvez également vous connecter via Google si vous avez lié votre compte.</p></div>
            </div>
            <div class="faq-item">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer"><p>Oui, notre logiciel est responsive et accessible depuis n’importe quel navigateur mobile. Une application native est également prévue pour 2025.</p></div>
            </div>
            <div class="faq-item">
                <div class="faq-question"><span>5. Mes données sont-elles sécurisées ?</span> <i class="fas fa-chevron-down"></i></div>
                <div class="faq-answer"><p>Absolument. Toutes les données sont chiffrées (SSL 256 bits) et hébergées en Europe. Nous effectuons des sauvegardes quotidiennes. Voir aussi section 7️⃣.</p></div>
            </div>
        </section>
        ...
        <section id="paiement" class="faq-section">
            ...
            <div class="faq-item"><div class="faq-question"><span>6. Comment souscrire à un abonnement ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Allez dans l'onglet "Abonnement" de votre espace, choisissez le pack qui vous convient (Mensuel/Annuel) et suivez les instructions de paiement.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>7. Quels moyens de paiement sont acceptés ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Carte bancaire (Visa, Mastercard), Mobile Money (Orange Money, Moov Money) et Paypal. En fonction de votre pays, d'autres options peuvent être disponibles.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>8. Mon paiement a été débité mais mon abonnement n’est pas activé, que faire ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Patientez 5 à 10 minutes (parfois le temps de confirmation). Si toujours rien, contactez le support avec votre reçu de paiement, nous activerons manuellement.</p></div></div>
            ...
            <div class="faq-item"><div class="faq-question"><span>11. Puis-je annuler mon abonnement ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Oui, depuis la rubrique "Facturation". L'annulation prend effet à la fin de la période en cours, sans frais.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>12. Comment télécharger ma facture ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Dans "Mon compte" > "Factures", vous trouverez la liste de toutes vos factures au format PDF téléchargeable.</p></div></div>
        </section>
        ...
        <section id="produits" class="faq-section">
            ...
            <div class="faq-item"><div class="faq-question"><span>13. Comment ajouter un produit ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Menu "Produits" > "Ajouter un produit". Remplissez les champs : nom, prix, stock initial, code-barres éventuel. Validez.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>14. Comment modifier ou supprimer un produit ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Cliquez sur les trois points à côté du produit dans la liste. Choisissez "Modifier" ou "Supprimer". Attention : suppression définitive.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>15. Comment gérer le stock ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Chaque vente diminue le stock automatiquement. Vous pouvez aussi faire des ajustements manuels via "Inventaire" > "Ajuster le stock".</p></div></div>
            ...
            <div class="faq-item"><div class="faq-question"><span>17. Puis-je importer mes produits en masse ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Oui, via un fichier CSV ou Excel. Rendez-vous dans "Produits" > "Importer". Un modèle est téléchargeable pour vous guider.</p></div></div>
        </section>
        ...
        <section id="utilisateurs" class="faq-section">
            ...
            <div class="faq-item"><div class="faq-question"><span>18. Comment ajouter un utilisateur ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Dans "Paramètres" > "Gestion des utilisateurs", cliquez sur "Inviter". Saisissez son email et choisissez son rôle.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>19. Puis-je limiter les droits d’un utilisateur ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Oui, plusieurs rôles existent : Administrateur, Manager, Commercial, Comptable... Vous pouvez aussi créer des droits personnalisés.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>20. Combien d’utilisateurs puis-je ajouter selon mon pack ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Pack Basic : 2 utilisateurs, Pro : 5 utilisateurs, Business : 15 utilisateurs, Enterprise : illimité.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>21. Comment supprimer un utilisateur ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Allez dans la liste des utilisateurs, activez le compte concerné, puis cliquez sur "Désactiver" ou "Supprimer définitivement".</p></div></div>
        </section>

        <!-- 5️⃣ Ventes & Rapports -->
        <section id="ventes" class="faq-section">
            <div class="section-title"><i class="fas fa-chart-line"></i> 5️⃣ Ventes & Rapports</div>
            <div class="faq-item"><div class="faq-question"><span>22. Comment enregistrer une vente ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Depuis le menu "Ventes" ou le raccourci "Nouvelle vente". Ajoutez les produits, choisissez le mode de paiement, validez.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>23. Comment voir le chiffre d’affaires du mois ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Le tableau de bord affiche le CA du jour, de la semaine et du mois. Pour plus de détails, utilisez l'onglet "Rapports".</p></div></div>
        ...
        <section id="technique" class="faq-section">
            ...
            <div class="faq-item"><div class="faq-question"><span>27. Une page ne s’affiche pas correctement.</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Rafraîchissez la page (Ctrl+F5). Testez avec un autre navigateur. Signalez-nous le problème via le chat.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>28. Je reçois une erreur après paiement.</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Notez le code erreur et contactez le support financier. Ne faites pas un second paiement sans vérification.</p></div></div>
        ...
        <section id="bonus" class="faq-section">
            ...
            <div class="faq-item"><div class="faq-question"><span>34. Proposez-vous un accompagnement personnalisé ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Pour les packs Business et Enterprise, un account manager dédié vous suit. Pour les autres, du support prioritaire est disponible en option.</p></div></div>
            <div class="faq-item"><div class="faq-question"><span>35. Comment contacter le support ?</span><i class="fas fa-chevron-down"></i></div><div class="faq-answer"><p>Par chat en bas à droite de l'écran, par email (support@logiciel.com) ou par téléphone au +225 00 00 00 00 (lun-ven 8h-18h).</p></div></div>
        </section>

        <hr>
        <footer>
            <i class="fas fa-comment-dots" style="color: #2563eb;"></i> Une autre question ? <strong>Contactez notre support</strong> — nous répondons sous 2h ouvrées.
        </footer>
    </div>
